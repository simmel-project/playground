...
static uint16_t mod_duty_cycles_transition01[4*16] = {
					 ...
					 96, 0, 0, 179,
					 96, 0, 0, 172,
					 96, 0, 0, 172, // total shortening should be -192/2 = -96
					 96, 0, 0, 179, // to give -pi phase shift to carrier
					 96, 0, 0, 184,
					 96, 0, 0, 188,
					 96, 0, 0, 190,
					 96, 0, 0, 191,
...
static uint16_t mod_duty_cycles_transition10[4*16] = {
					 ...
					 96, 0, 0, 205,
					 96, 0, 0, 212,
					 96, 0, 0, 212, // total lengthening should be 192/2 = 96
					 96, 0, 0, 205, // to give +pi phase shift to carrier
					 96, 0, 0, 200,
					 96, 0, 0, 196,
					 96, 0, 0, 194,
					 96, 0, 0, 193,
